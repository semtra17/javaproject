...
public interface IPermisoService {
	...
	public List<PermisoDiario> traerDiarioEntreFechas(LocalDate fechaDesde, LocalDate fechaHasta);
	public List<PermisoPeriodo> traerPeriodoEntreFechas(LocalDate fechaDesde, LocalDate fechaHasta);
